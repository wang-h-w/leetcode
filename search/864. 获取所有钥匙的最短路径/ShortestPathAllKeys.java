...
class ShortestPathAllKeys {
	...
	public static void main(String[] args) {
		ShortestPathAllKeys path = new ShortestPathAllKeys();
		System.out.println(path.shortestPathAllKeys(new String[] {"@.a.#","###.#","b.A.B"}));
		System.out.println(path.shortestPathAllKeys(new String[] {"@..aA","..B#.","....b"}));
		System.out.println(path.shortestPathAllKeys(new String[] {"@Aa"}));
	}
}